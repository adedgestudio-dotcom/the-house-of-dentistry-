      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative">
          <div className="relative aspect-square max-w-lg mx-auto">
            ...
            {/* Floating cards */}
            <div className="absolute top-8 -left-4 bg-white rounded-2xl p-4 shadow-xl flex items-center gap-3 animate-float">
              <div className="w-12 h-12 rounded-xl bg-emerald-100 flex items-center justify-center text-2xl">
                🦷
              </div>
              <div>
                <p className="text-xs text-slate-500">Treatments Done</p>
                <p className="font-bold text-slate-900">10,000+</p>
              </div>
            </div>

            <div className="absolute top-1/2 -right-4 bg-white rounded-2xl p-4 shadow-xl flex items-center gap-3 animate-float-delayed">
            ...
            <div className="absolute bottom-8 left-8 bg-white rounded-2xl p-4 shadow-xl flex items-center gap-3 animate-float">
              <div className="w-12 h-12 rounded-xl bg-amber-100 flex items-center justify-center text-2xl">
                🏆
              </div>
              <div>
                <p className="text-xs text-slate-500">Years of Trust</p>
